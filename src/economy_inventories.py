...
from firms_inventories import Firms
from household_inventories import Household
...
class Economy:
    ...
    def __init__(self, n, d, j0, j1, a0, q, b):
    ...
    def init_house(self, labour, theta, gamma, phi, w_p):
        """
    ...
    def set_quantities(self):
        ...
        if self.q == 0:
            ...
            self.m_cal = self.firms.z - self.lamb
            ...
            self.m_cal = np.power(self.firms.z, self.zeta) - self.lamb
            self.v = np.array(self.lamb_a[0])
